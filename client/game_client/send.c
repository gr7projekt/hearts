...
void sendCard(Player player_1[], int nr, char* trick[], char recieved_trick[], Uint16 *port,char tmp[], char IP_ADDRESS[])
{
    UDPpacket *packet2;
    char str[4];
...
//    }
    ...
    /* Resolve server name  */
    if (SDLNet_ResolveHost(&ip, IP_ADDRESS, PORT) == -1)
    {
