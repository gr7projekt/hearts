...
{
    SDL_Texture* card_club[13] = {NULL};     //clubs - klöver
    SDL_Texture* card_diamond[13] = {NULL};   //diamonds - ruter
...
//        char recieved_trick[40] = {"10;20;32;03;23;13;16;27;28;29;3A;2B;0B;"};
        char recieved_trick[40] = {"0B;2B;3A;29;28;27;16;13;23;03;32;20;10;"};
        char tmp[4];
...
//                  }printf("\n");
                ...
                if (strlen(recieved_trick)==39)  //om runda �r klar och n�gon vunnit, ladda nya kort.
                {
                    resetTurn(player_1, player_2, player_3, player_4);
                    winner = false;
                    loadCard(player_1, player_2, player_3, player_4, recieved_trick); //kortet som delas ut
